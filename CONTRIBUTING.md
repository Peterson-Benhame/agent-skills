...
nx g @peterson-benhame/skill-plugin:skill my-skill --category=development

# Full options
nx g @peterson-benhame/skill-plugin:skill my-skill \
...
agent-skills/
├── packages/
│   ├── cli/                          # @peterson-benhame/agent-skills — installs skills into agents
│   ├── mcp/                          # @peterson-benhame/agent-skills-mcp — serves skills over MCP
...
├── libs/
│   └── core/                         # @peterson-benhame/core — shared types and services
├── tools/
