...
<p align="center">
  <img src="https://img.shields.io/npm/v/@peterson-benhame/agent-skills?style=flat-square&color=blue" alt="npm version" />
  <img src="https://img.shields.io/npm/dt/@peterson-benhame/agent-skills?style=flat-square&color=blue" alt="total downloads" />
  <img src="https://img.shields.io/npm/dm/@peterson-benhame/agent-skills?style=flat-square&color=blue" alt="monthly downloads" />
...
```bash
npx @peterson-benhame/agent-skills
```
...
> **Note**: You can use either `npx @peterson-benhame/agent-skills` or install globally and use `agent-skills` directly.
...
```bash
npm install -g @peterson-benhame/agent-skills
agent-skills  # Use 'agent-skills' instead of 'npx @peterson-benhame/agent-skills'
```
...
`@peterson-benhame/agent-skills-mcp` is an MCP server that exposes the skills catalog directly to AI agents via **progressive disclosure** — search first, then fetch only what's needed.
...
```json
{
  "mcpServers": {
    "agent-skills": {
      "command": "npx",
      "args": ["-y", "@peterson-benhame/agent-skills-mcp"]
    }
  }
}
```
