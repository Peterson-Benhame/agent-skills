const stages = [
  ...
  },
  {
    ...
    body: 'pbs-discover. Bug often skips this. A feature does not. Problem, success metric, architecture and signatures, before code exists.',
    coming: false,
  },
  {
    tag: 'PLAN',
    ...
    body: 'pbs-plan. Observable outcomes with concrete values. Each slice proves something a later agent can build without guessing.',
    coming: false,
  },
  {
    tag: 'IMPLEMENT',
    ...
    body: 'pbs-implement. Isolated sandbox, own branch, vertical slice, cheap checks first. An independent verifier proves every check. The author never verifies their own work.',
    coming: false,
  },
  {
    tag: 'GATE',
