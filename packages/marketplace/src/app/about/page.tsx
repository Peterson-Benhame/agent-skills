...
export const metadata = buildPageMetadata({
  ...
  description:
    'Agent Skills é um registro open source, com verificação de segurança, de instruções empacotadas para agentes de IA voltados à programação, mantido pelo Tech Leads Club.',
  path: routes.about(),
})
...
const securityFeatures = [
  { title: 'Code review', desc: 'Toda skill passa por revisão manual de código antes da publicação' },
  { title: 'Limites de conteúdo', desc: 'Verificação de integridade com hash de conteúdo padronizado' },
  { title: 'Acesso restrito', desc: 'Sem execução de workflows ou injeção de conteúdo além dos limites da skill' },
  { title: 'Transparência', desc: 'Código-fonte completo disponível — inspecione qualquer skill antes de instalá-la' },
]
...
const howItWorks = [
  {
    step: '1',
    title: 'Browse',
    desc: `Encontre skills que atendam às suas necessidades em nosso catálogo selecionado com mais de ${marketplaceData.stats.totalSkills} skills distribuídas em ${marketplaceData.stats.totalCategories} categorias.`,
  },
  {
    step: '2',
    title: 'Install',
    desc: "Use a CLI para baixar e instalar skills no diretório de skills do seu agente de programação.",
  },
  {
    step: '3',
    title: 'Use',
    desc: 'Seu agente de IA carrega automaticamente as skills instaladas e aplica seu conhecimento especializado às tarefas relevantes.',
  },
]

const mcpTools = [
  { tool: 'list_skills', desc: 'Liste todas as skills disponíveis no catálogo' },
  { tool: 'get_skill_details', desc: 'Obtenha todos os detalhes de uma skill específica' },
  { tool: 'search_skills', desc: 'Encontre skills por palavra-chave ou categoria' },
  { tool: 'install_skill', desc: 'Baixe e instale uma skill localmente' },
]
      ...
      <div className="max-w-[820px] mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400 mb-3">
            Skills são instruções e recursos empacotados que ampliam as capacidades de agentes de IA.
            Pense nelas como plugins para o seu assistente de IA — elas ensinam ao agente novos workflows, padrões e conhecimentos especializados.
          </p>
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400">
            Cada skill contém arquivos de instruções, materiais de referência opcionais e scripts de automação que seu 
            agente de IA utiliza para fornecer assistência especializada em domínios específicos.
        ...
        <section className="mb-12">
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400 mb-4">
            A segurança do seu ambiente é nossa principal prioridade. Diferentemente de marketplaces abertos, nos quais 15,4% das skills 
            contêm problemas críticos, o Agent Skills utiliza um processo de revisão em múltiplas camadas:
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400 mb-4">
            Instale skills em qualquer um destes agentes de programação com IA:
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 border-b border-gray-100 dark:border-gray-800">
                    Diretório de skills do projeto
                  </th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="mb-12">
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400 mb-4">
            Uma prévia do que está disponível em nosso catálogo em crescimento:
          </p>
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl overflow-hidden">
            <table className="w-full text-sm border-collapse">
              <thead>
          ...
          <div className="text-center mt-4">
            ...
            >
              Ver todas as {marketplaceData.stats.totalSkills} skills →
            </Link>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400 mb-4">
            Instale skills diretamente pela sua CLI:
          </p>
          <div className="bg-slate-900 dark:bg-slate-950 rounded-xl p-4 sm:p-5 relative">
            <code className="text-[13px] text-sky-400 font-mono whitespace-pre-wrap block leading-relaxed">
              {`# Install a specific skill
npx @peterson-benhame/agent-skills install --skill accessibility

# Interactive browser
npx @peterson-benhame/agent-skills install

# Install all skills
npx @peterson-benhame/agent-skills install --all`}
            </code>
            <div className="absolute top-3 right-3">
              <CopyButton
                text={`npx @peterson-benhame/agent-skills install --skill accessibility`}
        ...
        <section className="mb-12">
          ...
          <p className="text-[15px] leading-[1.8] text-gray-500 dark:text-gray-400 mb-4">
            O MCP Server incluído disponibiliza o catálogo de skills diretamente para agentes de IA por meio do Model Context Protocol.
