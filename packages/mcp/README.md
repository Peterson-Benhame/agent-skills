...
|                 | **CLI** (`@peterson-benhame/agent-skills`)                                                    | **MCP** (this package)                                                            |
| :-------------- | :------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- |
...
```bash
claude mcp add agent-skills -- npx -y @peterson-benhame/agent-skills-mcp
```
...
```bash
npm run build              # Build all (or: npx nx build @peterson-benhame/agent-skills-mcp)
npx nx lint @peterson-benhame/agent-skills-mcp
npx nx test @peterson-benhame/agent-skills-mcp
...
```bash
npx nx build @peterson-benhame/agent-skills-mcp
npx nx lint @peterson-benhame/agent-skills-mcp
npx nx test @peterson-benhame/agent-skills-mcp
