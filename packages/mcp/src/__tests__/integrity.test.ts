...
describe('cdn pinning', () => {
  ...
  it('uses SKILLS_CDN_REF when set', async () => {
    ...
    expect(buildRegistryUrl('1.2.3')).toBe(
      'https://cdn.jsdelivr.net/npm/@peterson-benhame/skills-catalog@1.2.3/skills-registry.json',
    )
    expect(buildSkillsBaseUrl('1.2.3')).toBe(
      'https://cdn.jsdelivr.net/npm/@peterson-benhame/skills-catalog@1.2.3/skills/',
    )
